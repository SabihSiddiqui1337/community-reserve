...
mixin _$Reservation {
 ...
 String get id; String get amenityId; String get userId;@TimestampConverter() DateTime? get startTime;@TimestampConverter() DateTime? get endTime; ReservationStatus get status; String? get pinHash; String? get salt; String? get qrToken; String? get accessCredentialId;@TimestampConverter() DateTime? get checkedInAt;@TimestampConverter() DateTime? get createdAt;@TimestampConverter() DateTime? get cancelledAt; String? get paymentId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,amenityId,userId,startTime,endTime,status,pinHash,salt,qrToken,accessCredentialId,checkedInAt,createdAt,cancelledAt,paymentId);

@override
String toString() {
  return 'Reservation(id: $id, amenityId: $amenityId, userId: $userId, startTime: $startTime, endTime: $endTime, status: $status, pinHash: $pinHash, salt: $salt, qrToken: $qrToken, accessCredentialId: $accessCredentialId, checkedInAt: $checkedInAt, createdAt: $createdAt, cancelledAt: $cancelledAt, paymentId: $paymentId)';
}
...
/// Create a copy of Reservation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? amenityId = null,Object? userId = null,Object? startTime = freezed,Object? endTime = freezed,Object? status = null,Object? pinHash = freezed,Object? salt = freezed,Object? qrToken = freezed,Object? accessCredentialId = freezed,Object? checkedInAt = freezed,Object? createdAt = freezed,Object? cancelledAt = freezed,Object? paymentId = freezed,}) {
...
as ReservationStatus,pinHash: freezed == pinHash ? _self.pinHash : pinHash // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String amenityId,  String userId, @TimestampConverter()  DateTime? startTime, @TimestampConverter()  DateTime? endTime,  ReservationStatus status,  String? pinHash,  String? salt,  String? qrToken,  String? accessCredentialId, @TimestampConverter()  DateTime? checkedInAt, @TimestampConverter()  DateTime? createdAt, @TimestampConverter()  DateTime? cancelledAt,  String? paymentId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Reservation() when $default != null:
return $default(_that.id,_that.amenityId,_that.userId,_that.startTime,_that.endTime,_that.status,_that.pinHash,_that.salt,_that.qrToken,_that.accessCredentialId,_that.checkedInAt,_that.createdAt,_that.cancelledAt,_that.paymentId);case _:
  return orElse();
...
class _Reservation implements Reservation {
  const _Reservation({required this.id, required this.amenityId, required this.userId, @TimestampConverter() this.startTime, @TimestampConverter() this.endTime, this.status = ReservationStatus.booked, this.pinHash, this.salt, this.qrToken, this.accessCredentialId, @TimestampConverter() this.checkedInAt, @TimestampConverter() this.createdAt, @TimestampConverter() this.cancelledAt, this.paymentId});
...
/// Create a copy of Reservation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? amenityId = null,Object? userId = null,Object? startTime = freezed,Object? endTime = freezed,Object? status = null,Object? pinHash = freezed,Object? salt = freezed,Object? qrToken = freezed,Object? accessCredentialId = freezed,Object? checkedInAt = freezed,Object? createdAt = freezed,Object? cancelledAt = freezed,Object? paymentId = freezed,}) {
