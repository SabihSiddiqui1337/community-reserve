...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,amenityId,userId,startTime,endTime,status,court,pinHash,salt,qrToken,accessCredentialId,checkedInAt,createdAt,cancelledAt,paymentId);

@override
String toString() {
  return 'Reservation(id: $id, amenityId: $amenityId, userId: $userId, startTime: $startTime, endTime: $endTime, status: $status, court: $court, pinHash: $pinHash, salt: $salt, qrToken: $qrToken, accessCredentialId: $accessCredentialId, checkedInAt: $checkedInAt, createdAt: $createdAt, cancelledAt: $cancelledAt, paymentId: $paymentId)';
}
...
switch (_that) {
case _Reservation() when $default != null:
return $default(_that.id,_that.amenityId,_that.userId,_that.startTime,_that.endTime,_that.status,_that.court,_that.pinHash,_that.salt,_that.qrToken,_that.accessCredentialId,_that.checkedInAt,_that.createdAt,_that.cancelledAt,_that.paymentId);case _:
  return orElse();
